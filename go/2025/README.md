# Advent of code challenge 2025, in GO

Here are my solutions to the "Advent of code" challenge of 2025 implemented in GO (aka Golang).
See https://adventofcode.com/2025

I am doing this to keep practicing GO, so this must be considered as "student code". I am coding it to try my hand at various GO idioms, not seeking efficiency, scalability nor optimality. But feedback is very welcome.
...
- https://github.com/topics/advent-of-code-2025 The GitHub projects tagged with `advent-of-code-2025`
- https://www.reddit.com/r/adventofcode/ The reddit to discuss AOC 

## License
Author: (c)2025 Colas Nahaboo, https://colas.nahaboo.net
